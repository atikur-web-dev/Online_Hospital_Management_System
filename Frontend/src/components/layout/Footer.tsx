    ...
    <footer className="bg-white border-t border-emerald-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="mt-4 flex gap-3">
              <a
                href="#"
                className="p-2.5 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors text-emerald-700 hover:text-emerald-800"
                aria-label="Facebook"
              >
                <svg
          ...
          <div>
            ...
            <ul className="space-y-3 text-base text-emerald-700">
              ...
              <li className="flex items-start gap-2">
                <Phone className="w-5 h-5 mt-0.5 text-emerald-600 shrink-0" />
                <a
              ...
              <li className="flex items-start gap-2">
                <Mail className="w-5 h-5 mt-0.5 text-emerald-600 shrink-0" />
                <a
        ...
        <div className="mt-12 pt-8 border-t border-emerald-100 text-center text-base text-emerald-700">
          <p>&copy; {currentYear} CarePlus. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
