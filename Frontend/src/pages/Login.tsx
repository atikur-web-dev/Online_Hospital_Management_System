        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/95 text-emerald-600">Or continue with</span>
            </div>
          </div>
          ...
          >
            ...
            <span className="font-medium text-emerald-800">Sign in with Google</span>
          </button>
        </div>

        <p className="mt-6 text-center text-sm text-emerald-700">
          Don't have an account?{' '}
          <a href="/register" className="font-semibold text-emerald-600 hover:text-emerald-800">
            Sign up
          </a>
        </p>
      </div>
